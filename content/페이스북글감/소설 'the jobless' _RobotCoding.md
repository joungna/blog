...
[ Quartz 설치법](https://hel-p.tistory.com/56 )
Quartz를 내 Github Repository에 불러오기 https://github.com/joungna/blog.git
...
변동사항을 commit하고 push한 후 cloudflare에 배포가 완료
git add .
git commit -m "변경한 내용 간단히 적기"
git push
push가 완료되면, Cloudflare Pages가 자동으로 새 버전을 배포합니다.

배포는 보통 30초~2분 정도 걸립니다.
